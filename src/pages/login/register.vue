  ...
  <div class="login">
    ...
    <div class="contain">
      <div class="input">
        ...
        <div class="code">
          <input class="color-333 font32" type="number"   placeholder="客户经理编号(选填)"  maxlength="4" v-model="form.managerNumber">
        </div>
      </div>
    ...
    <div class="dialog" v-if="showDialog">
      ...
      <div class="dialog-box">
        <div class="dialog-inner">
          ...
          <img :src="imgUrl" alt="" class="yzm-1" @click="getCode">
...
<script>
  import {checkImagesCode, checkUserPhone} from '@/api/login'
  ...
  export default {
    ...
    methods: {
      ...
      initState () {
        this.form = {...this.form, ...this.registInfo}
      },
      getSafeCode () {
